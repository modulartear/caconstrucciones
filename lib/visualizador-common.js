...
export const TEMPLATES = [
  { id: 'wall', label: 'Pared', target: 'wall', imageUrl: '/visualizador-assets/wall-original.png', maskUrl: '/visualizador-assets/wall-mask.png', maskFile: 'wall-mask.png', imageFile: 'wall-original.png' },
  { id: 'floor', label: 'Piso', target: 'floor', imageUrl: '/visualizador-assets/floor-original.png', maskUrl: '/visualizador-assets/floor-mask.png', maskFile: 'floor-mask.png', imageFile: 'floor-original.png' },
  { id: 'facade', label: 'Fachada', target: 'facade', imageUrl: '/visualizador-assets/facade-original.png', maskUrl: '/visualizador-assets/facade-mask.png', maskFile: 'facade-mask.png', imageFile: 'facade-original.png' }
];
