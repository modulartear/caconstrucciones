...
function fallbackMaterials() {
  return [
    { id: 'wall_paint_white', label: 'Pintura blanco lino', target: 'wall', prompt: 'warm white matte wall paint', swatch: '#f3ede1', renderMode: 'paint' },
    { id: 'wall_microcement', label: 'Microcemento gris', target: 'wall', prompt: 'smooth gray microcement finish', swatch: '#8a8983', renderMode: 'material' },
    { id: 'floor_oak', label: 'Roble natural', target: 'floor', prompt: 'natural oak wood flooring', swatch: '#a87a4d', renderMode: 'material' },
    { id: 'facade_stone', label: 'Piedra natural', target: 'facade', prompt: 'natural stone facade cladding', swatch: '#8e7958', renderMode: 'material' }
  ];
}
