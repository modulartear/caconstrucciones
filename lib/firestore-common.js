...
const collectionHandlers = {
  ...
  budgets: {
    ...
    async post(data) {
      ...
      const docData = {
        id: docId, client, email, phone, type, surface, message, locality,
        status: status || 'nuevo', date, source, clientId, sessionId,
        visualizerImage, visualizerOriginalImage, visualizerScene, visualizerTarget,
        visualizerMaterialId, visualizerMaterialName, visualizerMaterialPhoto
      };
